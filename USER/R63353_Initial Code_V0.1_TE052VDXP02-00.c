...
//     Tianma 204 pin
//     TE052VDXP02-00
//     Panel1 : CMOS Demux + CMOS VSR 1V1
//     (CMOS 2CLK Interlace)
//     Rev000
//
// *****************************************************************************"
...
//Manufacturer Command Access Protect
	0X1BC, 0X202,
	   	   0X200,
	0X1BF, 0X2B0,
	   	   0X204,//OR 0X200 4:could be access
//Interface setting	
	0x1BC, 0x206,
	       0x200,
  0x1BF, 0x2B3, 
...
//Display Setting 1	
	...
	0x1BF, 0x2C1,
	       0x20C, //P1   BLS, BLREV, PTLREV, REV,BGR1, SS1
				 0x2A0, //P2   HRE1
				 0x200, //P3   NWZIG,RGBSWLP,UDS[0]:00:Forward 01:Backward
				 0x272, //P4   GSWAP
				 0x294, //P5   GSWAP
				 0x29C, //P6   GSWAP
				 0x21B, //P7   GSWAP
...
//Display Setting 
	0x1BC, 0x22D,   
	       0x200,   
	0x1BF, 0x2C2,   
	       0x235, //PSEUDO_EN,PSEUDO_LINE,PNLSEL
				 0x2F7, //LINEINVA NL   07 dot-inversion, F7 column-inversion
				 0x280, //NL
...
//RCLK£º 28M = 1/28 uS = 35.7nS
	...
	0x1BF, 0x2C6, 
	       0x201, //P1  RTN0[10:8]
				 ...
				 0x219, //P20 PSWW1 CKH width .  Sets the High or Low period of the SOUT signal
				 0x208, //P21 PSWG1 CKH Gap .          Sets the Non-overlap period of the SOUT sig
				 0x201, //P22 
				 0x290, //P23 
				 0x200, //P24 TRWC3/TRWC2/TRWC1/TRWC0 ????:60-->30Hz (00-55)need change this setting to magnification timing
...
//Power Setting for Charge Pump	
	0x1BC, 0x20B, 
	       0x200, 
	0x1BF, 0x2D0,
	       0x211, //P1  [7]BT3, [6:4]DC3, [4]BT2, [3:0]DC2 (setting VGH >(VCI2*2)10V (1EH) BT2 must be set;setting VGL<(VSN-VCI3) [-7-3.6V]=-10.6V BT3 should be set
				 0x200, //P2
				 0x200, //P3
...
//Power Setting for Internal Power		   
	...
	0x1BF, 0x2D3,
	       0x21B, //P1
				 ...
				 0x233, //P8
				 0x233, //P9
				 0x200, //P10 [7:4]SEQGND1, [3:0]SEQGND2 This register sets Source GND period. Refer to the Appendix for details
				 0x201, //P11 
				 0x200, //P12 
				 0x200, //P13 
				 0x2DF, //P14 [7:4]:VC2[3:0] = 5V
				 0x2A0, //P15 
				 0x206, //P16 [3:0]:VC3[3:0] = 3.6V
				 0x25B, //P17 VPL 5B--5.2V 67-5.5V   6F-5.7V
				 0x25B, //P18 VNL
				 0x233, //P19 set source driving  33->77
				 0x233, //P20 
				 0x272, //P21 VBTS[1:0]=0~3 (VSP LVD 4.74 5.10 4.02V 4.42)
				 0x212, //P22 VBTS_IOVCC[1:0]=0~3(IOVCC LVD x x 1.50V 1.55)
				 0x28A, //P23 VBTS_VCI[1:0]=0~3 (VCI LVD 1.84 1.95 2.14V x)
				 0x207, //P24 [7:6]GVDDDRCT, [5:4]GVSSDRCT
				 0x23D, //P25 
				 0x2BC, //P26 
