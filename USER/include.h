...
#define SPEC_MIN_LEDA_NORMAL	0.0 				        //mA 38.0
#define SPEC_MAX_LEDA_NORMAL	50.0								//mA 42.0

#define SPEC_MIN_LEDA_DIM			0.0				          //mA 1.6
#define SPEC_MAX_LEDA_DIM			20.0								//mA 2.4

//**********************************OTP, GAMMAEXPERT SETTING BEGIN*******************************************************//
//=======================BASIC SETTING(NECESSARY)=================================//
#define	PROJECT_NO						"TL057FDXP03-00_G5.5" //TL063FVMC02-01_G6
#define Info_IC_Vendor				"ILITEC"				//IC vendor,replace in HIMAX/RSP/NOVATEK/ORISE/ILITEC
#define Info_IC_Type					"7807D"				//IC part number:Select IC type
...
#define Info_Min_VCOM					"0000"							//VCOM down limitation
#define Info_Max_VCOM					"002F"							//VCOM up limitation
#define Info_Typical_VCOM			"000F"							//VCOM typical
//=========================SPEC SETTING(NECESSARY)================================//
#define SPEC_Lv 							300.00
#define SPEC_Lv_MAX						600.00
#define SPEC_x 								0.290
#define SPEC_y								0.310
#define SPEC_xy_RANGE 				0.05						//Default TM spec = 0.05
