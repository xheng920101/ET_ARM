...
//Gamma setting common set
	0X1BC,	0X21F,
	   	   	0X200,
	0X1BF,	0X2C7,
//----------------- GAMMA--------------// Normal Gamma 20160229 ok for ASUS Libra ¸ºÐÔÒº¾§
	   	   	0X200,
	   	   	0X211,
	   	   	0X21b,
	   	   	0X227,
...
//Power setting 1 for charge pump 
	...
	0X1BF,	0X2D0,
	   	   	...
	   	   	0X200,
	   	   	0X200,
	   	   	0X254,	// GVDD(VGH) D[5:0]=12h(8.0V), VLM2E D[6]=1h(VGH=GVDD, when GVDDDRCT=1h)
...
//Power setting for internal power
	...
	0X1BF,	0X2D3,
	   	   	...
	   	   	0X253,	// VNLVL=2F(4.100V)  53h = 5V
	   	   	0X253,	// VPLVL=2F(4.100V)
	   	   	0X233,
	   	   	0X233,
...
//Gamma setting common set
	0X1BC,	0X21F,
	   	   	0X200,
	0X1BF,	0X2C7,
//----------------- GAMMA--------------// Normal Gamma 20150526 ok
	   	   	0X200,
	   	   	0X202,
	   	   	0X205,
	   	   	0X20a,
...
//Digtal Gamma setting
	0X1BC,	0X214,
	   	   	0X200,
	0X1BF,	0X2C8,
					0x200,				//Digital gamma control.D[0]= 0:off;	D[0] = 1:on
	   	   	0x200,
	   	   	0x206,
	   	   	0x2FC,
	   	   	0x202,
...
//Power setting for internal power
	...
	0X1BF,	0X2D3,
	   	   	...
	   	   	0X2A0,
	   	   	0X205,	// VC3 D[3:0]=5h(3.4v), VCI3 is internal voltage for generating VGL.
	   	   	0X25B,	// VNLVL=2F(4.100V)  53h(5V)		5Bh(5.2V)
	   	   	0X25B,	// VPLVL=2F(4.100V)
	   	   	0X233,
	   	   	0X233,
	   	   	0X272,	// VBTS D[1:0]=2h(4.02V), detect VSP to enter APO sequence.(VBTS function is available, when VCIONB=GND(select internal(IOVCC)/external(GND) VCI).)
	   	   	0X212,	// VBTS_IOVCC D[1:0]=2h(1.50V), detect IOVCC to enter APO sequence.
