...
//Display Setting 2	
	...
	0x1BF, 0x2C2,
	       0x235, //P1  PSEUDO_EN,PSEUDO_LINE,PNLSEL
				 0x2F7, //P2  //LINEINVA NL   07 dot-inversion, F7 column-inversion
				 0x280, //P3  NL
...
//Source Timing Setting	
	...
	0x1BF, 0x2C4,
	       0x230, //P1  DIV
				 ...
				 0x201, //P14 SNT1
				 0x205, //P15 SNT2 SNTx :These registers set s source output delay.
...
//SWx:  Sets the High or Low period of the SOUT signal.
	...
	0x1BF, 0x2C6, 
	       0x201, //P1  RTN0[10:8]
				 ...
				 0x200, //P17 ST8
				 0x200, //P18 SW9
				 0x218, //P19 PSWT1 CKH rising edge .  Sets the Rising or Falling position of the SOUT signa
