...
//	0X1BA,	0X266,	0X2C3,		// 24MHz * 106 / 3 = 848Mbps, 24MHz * 102 / 3 = 816Mbps	 135*24/4=810  
	...
	0X1BB,	0X20B,	0X200,		// 0F: 900/8/16 = 7.03125MHz, 0B: 900/8/12 = 9.375MHz
...
//// C590 Set VGH/VGL = Hzi whe sleeping
//	0x1BC,	0x202,	0x200,
//	0x1BF,	0x200,	0x290,
//	0x1BC,	0x202,	0x200,
//	0x1BF,	0x2C5,	
//					0x255, // 20150715 cancel
...
// C580H  - Pump & regulator
	...
	0x1BF,	0x2C5,	
					...
					0x255,
					0x250,
					0x205, //VGHO Delta voltage setting (VTP): HVREG_TP_SEL=4.5V 20150715 4.5V(06)->1.5V(00)  20150720 1.5V(00)->4.5V(06)  20160517 4.5V(06)->4.0V(05)
...
// C590H  - power control setting
	...
	0x1BC,	0x20B,	0x200,
	0x1BF,	0x2C5,	
					0x244, //HVREG_VGHO2_ON_SET=VGHO2, HVREG_VGHO2_OFF_SET=GND; HVREG_VGLO2_ON_SET=VGHL2, HVREG_VGLO2_OFF_SET=GND; 
...
// D800H - GVDDP GVDDN
	...
	0x1BF,	0x2D8,	
////----------------NLC---------------//
//					0x22F, //1 31: 5.3V  2F: 5.2V 2B£º5.0V
//					0x22F,
            0x22B,
            0x22B,
////----------------PLC---------------//
...
// C590H - 20160517 add for LPWG mode VGHO voltage setting.
	0x1BC,	0x202,	0x200,
	0x1BF,	0x200,	0x290,
	0x1BC,	0x202,	0x200,
	0x1BF,	0x2C5,	
					0x277, //
// F381H - 20160514 add LPWG mode power off sequence setting for recover flicker issue.
	0x1BC,	0x202,	0x200,
	0x1BF,	0x200,	0x281,
	0x1BC,	0x20D,	0x200,
	0x1BF,	0x2F3,
...
//0x1BF,0x200,0x200,
//0x1BC,0x210,0x200,
//0x1BF,0x2ec,0x200,0x204,0x208,0x20c,0x200,0x210,0x214,0x218,0x21c,0x200,0x220,0x228,0x230,0x238,0x200,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x210,
//0x1BC,0x210,0x200,
//0x1BF,0x2ec,0x240,0x248,0x250,0x258,0x200,0x260,0x268,0x270,0x278,0x200,0x280,0x288,0x290,0x298,0x200,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x220,
//0x1BC,0x210,0x200,
//0x1BF,0x2ec,0x2a0,0x2a8,0x2b0,0x2b8,0x200,0x2c0,0x2c8,0x2d0,0x2d8,0x200,0x2e0,0x2e8,0x2f0,0x2f8,0x200,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x230,
//0x1BC,0x205,0x200,
//0x1BF,0x2ec,0x2fc,0x2fe,0x2ff,0x200,

//0x1BC,0x202,0x200,
//0x1BF,0x200,0x200,
//0x1BC,0x210,0x200,
//0x1BF,0x2ed,0x200,0x203,0x207,0x20b,0x2bc,0x20f,0x213,0x217,0x21a,0x2c1,0x21e,0x226,0x22d,0x235,0x2b6,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x210,
//0x1BC,0x210,0x200,
//0x1BF,0x2ed,0x23d,0x244,0x24c,0x254,0x22d,0x25b,0x263,0x26b,0x272,0x287,0x27a,0x282,0x289,0x291,0x261,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x220,
//0x1BC,0x210,0x200,
//0x1BF,0x2ed,0x298,0x2a0,0x2a8,0x2af,0x2cb,0x2b7,0x2bf,0x2c6,0x2ce,0x272,0x2d6,0x2dd,0x2e5,0x2ec,0x2d8,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x230,
//0x1BC,0x205,0x200,
//0x1BF,0x2ed,0x2f0,0x2f2,0x2f3,0x22b,

//0x1BC,0x202,0x200,
//0x1BF,0x200,0x200,
//0x1BC,0x210,0x200,
//0x1BF,0x2ee,0x200,0x203,0x207,0x20a,0x288,0x20e,0x211,0x215,0x218,0x2dc,0x21c,0x223,0x22a,0x231,0x295,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x210,
//0x1BC,0x210,0x200,
//0x1BF,0x2ee,0x238,0x23f,0x246,0x24d,0x2aa,0x254,0x25b,0x262,0x269,0x2ff,0x271,0x278,0x27f,0x286,0x200,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x220,
//0x1BC,0x210,0x200,
//0x1BF,0x2ee,0x28d,0x294,0x29b,0x2a2,0x254,0x2a9,0x2b0,0x2b7,0x2be,0x2a9,0x2c5,0x2cc,0x2d3,0x2da,0x2fa,
//0x1BC,0x202,0x200,
//0x1BF,0x200,0x230,
//0x1BC,0x205,0x200,
//0x1BF,0x2ee,0x2de,0x2e0,0x2e1,0x201,
