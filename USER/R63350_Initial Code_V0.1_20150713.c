...
//Gamma setting common set
	...
	0X1BF,	0X2C7,
//----------------- GAMMA--------------// Gamma 2.4 
                // ES3_gamma2.4(0.30,0.32)  ES3_gamma2.2(0.31,0.33)   ES3_gamma2.4(0.29,0.31)   20150921   20150928    20151008-ES3_gamma2.4(0.30,0.32)
//	   	   	0X200,//        00                         00                        00                 00         00           00    
//					0X20D,//        0C                         0B                        0C                 0C         0C           0D    
//					0X214,//        13                         12                        13                 13         14           14    
//					0X21E,//        1D                         1C                        1D                 1E         1D           1E    
//					0X22D,//        2D                         2B                        2D                 2D         2C           2D    
//					0X23C,//        3C                         39                        3C                 3B         3B           3C    
//					0X247,//        47                         44                        47                 47         46           47    
//					0X258,//        58                         56                        58                 58         57           58    
//					0X23F,//        3F                         3C                        3F                 3F         3E           3F    
//					0X248,//        48                         45                        48                 48         47           48    
//					0X256,//        55                         51                        55                 55         55           56    
//					0X263,//        63                         5F                        63                 63         62           63    
//					0X26B,//        6C                         68                        6C                 6C         6B           6B    
//					0X272,//        72                         6F                        72                 72         72           72    
//					0X277,//        77                         77                        77                 77         77           77    
//								     
//	   	   	0X200,//            
//					0X20D,//            
//					0X214,//            
...
//Power setting for internal power
	...
	0X1BF,	0X2D3,
	   	   	...
	   	   	0X25B,	// VNLVL=2F=4.1v 35=4.25v ; 37=4.3v ; 47=4.7v  4B=4.8V
	   	   	0X25B,	// VPLVL=2F=4.1v
	   	   	0X233,
	   	   	0X233,
...
//interface setting video mode
	0X1BC,	0X207,
	   	   	0X200,
	0X1BF,	0X2B3,
	   	   	0X214,	// Assignment of Display Mode and Based signals, DSI-internal OSC.
	   	   	0X200,
	   	   	0X200,	// Interval of TE signal output for every frame.
	   	   	0X200,
	   	   	0X200,
